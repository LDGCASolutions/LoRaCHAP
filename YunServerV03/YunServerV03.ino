...
int apiCall(char* page, char* parameters) {
  char* apiUrl = "https://lora-comm.herokuapp.com/api/";
  char* apiKey = "abcdefgHijkLMNOP";
  char* upload_url = apiUrl + page + "?&apiKey=" + apiKey + parameters;
